/**
 * `@operatoros/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@operatoros/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@operatoros/plugin-sdk/ui";
 *
