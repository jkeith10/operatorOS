...
import type { PaperclipPluginManifestV1 } from "@operatoros/shared";
 ...
 * import { startWorkerRpcHost } from "@operatoros/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@operatoros/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
