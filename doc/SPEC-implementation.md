...
- Third-party plugin marketplace and a formally supported public extension SDK (see note below)
...
- stable third-party plugin marketplace and extension certification (in-tree host/SDK exists; see §5.2 note)
