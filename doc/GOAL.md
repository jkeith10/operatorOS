...
**OperatorOS** is derived from [Paperclip](https://github.com/paperclipai/paperclip). The vision below is inherited from upstream product intent; this fork may narrow or extend it over time.

# Paperclip (upstream vision)
