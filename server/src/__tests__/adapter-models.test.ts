...
import { models as codexFallbackModels } from "@operatoros/adapter-codex-local";
import { models as cursorFallbackModels } from "@operatoros/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@operatoros/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@operatoros/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    vi.restoreAllMocks();
    vi.spyOn(configFile, "readConfigFile").mockReturnValue(null);
  });
