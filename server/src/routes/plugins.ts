...
import { companies, pluginLogs, pluginWebhookDeliveries } from "@operatoros/db";
import type {
  PluginStatus,
...
import type { ToolRunContext } from "@operatoros/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@operatoros/plugin-sdk";
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@operatoros/plugin-hello-world-example",
  ...
  {
    packageName: "@operatoros/plugin-file-browser-example",
  ...
  {
    packageName: "@operatoros/plugin-kitchen-sink-example",
