...
import { readPaperclipSkillSyncPreference } from "@operatoros/adapter-utils/server-utils";
import { claudeConfigDir, parseClaudeStreamJson } from "@operatoros/adapter-claude-local/server";
import { codexHomeDir, parseCodexJsonl } from "@operatoros/adapter-codex-local/server";
import { parseOpenCodeJsonl } from "@operatoros/adapter-opencode-local/server";
import {
