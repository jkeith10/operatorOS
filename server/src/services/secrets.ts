...
import { companySecrets, companySecretVersions } from "@operatoros/db";
import type { AgentEnvConfig, EnvBinding, SecretProvider } from "@operatoros/shared";
import { envBindingSchema } from "@operatoros/shared";
