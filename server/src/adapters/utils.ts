...
import * as serverUtils from "@operatoros/adapter-utils/server-utils";
export type { RunProcessResult } from "@operatoros/adapter-utils/server-utils";
...
export function buildInvocationEnvForLogs(
  ...
  // TODO: Remove this fallback once @operatoros/adapter-utils exports buildInvocationEnvForLogs everywhere we consume it.
...
import type { RunProcessResult } from "@operatoros/adapter-utils/server-utils";
