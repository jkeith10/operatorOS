...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@operatoros/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@operatoros/adapter-utils").TranscriptEntry[];
