 ...
 *
 * Plugin bundles are built with `external: ["@operatoros/plugin-sdk/ui", "react", "react-dom"]`,
 ...
 * - `import { ... } from "@operatoros/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@operatoros/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@operatoros/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@operatoros/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@operatoros/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@operatoros/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
