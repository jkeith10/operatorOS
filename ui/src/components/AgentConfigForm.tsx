...
// Canonical type lives in @operatoros/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@operatoros/adapter-utils";
import type { CreateConfigValues } from "@operatoros/adapter-utils";
