...
import type { FeedbackDataSharingPreference, FeedbackVoteValue } from "@operatoros/shared";
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Choose whether voted AI outputs can be shared with OperatorOS Labs. This
